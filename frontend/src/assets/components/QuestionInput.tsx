...
const QuestionInput = () => {
  ...
  return (
    <div className="w-full bg-white p-8 rounded-[30px] border border-gray-100 shadow-[0_20px_50px_rgba(0,0,0,0.05)] h-full flex flex-col">
      ...
      <button className="w-full mt-6 py-4 bg-gray-900 text-white rounded-xl font-bold text-lg flex items-center justify-center gap-3 hover:bg-black transition-all">
