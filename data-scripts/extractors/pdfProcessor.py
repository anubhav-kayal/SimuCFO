...
# 2. HELPER: Aggressive Period Finder (EXACTLY from anubhav2.py)
...
# 3. HELPER: Page Selector (EXACTLY from anubhav2.py)
...
# 4. CORE: AI Extraction (EXACTLY from anubhav2.py)
...
# 5. MAIN + PYTHON MATH REPAIR (EXACTLY from anubhav2.py)
async def main():
    ...
    print(f"📂 Found {len(pdf_files)} PDF files in 'inputs/'.")
